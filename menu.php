<?php
    ...
    if ( !isset( $_SESSION['cart'] ) ) {
        $truncate_query = "TRUNCATE TABLE `quantities`";
        $result = mysqli_query($connection , $truncate_query);
    }

    require_once("cart_sidebar.php");
        ...
        <div class="col-lg-12 text-center">
            <?php
                ...
                while($row=mysqli_fetch_assoc($result)){
                    ...
                    ?>
                        <div class="btn m-3 p-3" style="color:white; background-color:#e0518f; border-radius:30px; font-weight:bold; width:15rem;box-shadow: 3px 3px 5px rgba(0, 0, 0, .3);"> <?php  echo $row['category_name'] ?> </div>
                    <?php
                }
            ?>
        </div>
                ...
                while($row_2=mysqli_fetch_assoc($result_2)){
                    ...
                    ?>
                        <form action="cart.php" class="col-xl-3 col-md-5 col-sm-12 mt-3" method="get">
                            <div class="service-item" data-bs-toggle="modal" data-bs-target="#<?php echo $row_2['product_id'] ?>">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="cart.php" method="get">
                                            <div class="container-fluid border rounded-5">
                                                    ...
                                                    <div class="col-lg-12 d-flex">
                                                        ...
                                                        <div class="col-lg-6 my-auto">
                                                            ...
                                                            <div class="div d-flex border justify-content-around" style="border-radius:30px;">
                                                                <div class="plus_minus rounded-5"  onclick="subtract(<?php echo $row_2['product_id'] ?>)">-</div>
                                                                    <input type="text" class="d-none" name="product_id" value="<?php echo $row_2['product_id'] ?>">
                                                                    <input type="text" value="1" name="quantity" class="text-center w-25" id="quantity<?php echo  $row_2['product_id']?>" style="color:gray;font-weight:bolder;">
                                                                <div class="plus_minus rounded-5"  onclick="add(<?php echo  $row_2['product_id'] ?>)">+</div>
                                                            </div>
                                                            <hr>
                                                ...
                                                <div class="col-lg-12">
                                                    <input type="submit" class="btn animated fadeIn w-100 m-2" name="product" style="background-color:#e0518f;color:white;font-weight:bold;border-radius:30px; box-shadow: 2px 2px 2px rgba(0, 0, 0, .2);" value="Add To Cart">
