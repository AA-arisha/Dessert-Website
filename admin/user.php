<?php
    ...
    if( isset( $_GET['delete_user'] ) ){
        ...
        $delete = "DELETE FROM `clients` WHERE `client_id` = '$user_id'";
                            ...
                            while($row=mysqli_fetch_assoc($result)){
                                if ($row['client_role'] != "admin" ) {
                                    ?>
                                        ...
                                        <td class="fs-5">
                                            <a href="update_register.php?update_user&users_id=<?php echo$row['client_id']?>" ><i class="fa-solid fa-pen-to-square" style="color: #FFD43B;"></i> </a>
                                            <a href="user.php?delete_user&users_id=<?php echo$row['client_id']?>"><i class="fa-solid fa-trash" style="color: #ff6181;"></i></a>
