...
<!--===============================================================================================-->
  ...
  <body>
    ...
    <div class="site-mobile-menu site-navbar-target">
      ...
      <div class="cart_sidebar position-fixed top-50 end-0 m-3 p-2 position-relative" style="background-color:#e0518f;color:white;font-weight:bolder;font-size:16px;border-radius:5px;">
